...
/**
 * Build only conservative, unambiguous office links. Same-name rows remain
 * separate when CBDB offers more than one period-compatible identity.
 */
export function buildOfficeConcordance(norbert, cbdb) {
  ...
  for (const office of norbert) {
    ...
    out.push({
      ...
      evidence: {
        rule: 'exact-name+period-compatible',
